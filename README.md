...
키오스크 음성 주문용 **AI 백엔드 서버**입니다.  
React + Spring으로 구성된 키오스크 시스템에서, 이 서비스는 **LLM 기반 “주문 도우미 뇌” 역할**을 합니다.
...
> 결제/주문 저장/DB 연동 등은 **Python이 아니라 Spring 백엔드에서 처리**합니다.
